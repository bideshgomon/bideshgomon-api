                        ...
                        <form @submit.prevent="submit">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <SelectInput id="job_category_id" class="mt-1 block w-full" v-model="form.job_category_id" required>
                                ...
                                <div>
                                    ...
                                    <TextInput id="location" type="text" class="mt-1 block w-full" v-model="form.location" placeholder="e.g., Dhaka, Bangladesh or Remote" />
                                ...
                                <div>
                                    ...
                                    <TextInput id="salary_range" type="text" class="mt-1 block w-full" v-model="form.salary_range" placeholder="e.g., $50k - $70k per year" />
                                ...
                                <div>
                                    ...
                                    <TextInput id="apply_url" type="text" class="mt-1 block w-full" v-model="form.apply_url" placeholder="Link or email address for applications" />
                                ...
                                <div>
                                    ...
                                    <SelectInput id="employment_type" class="mt-1 block w-full" v-model="form.employment_type" required>
                                ...
                                <div>
                                    ...
                                    <SelectInput id="experience_level" class="mt-1 block w-full" v-model="form.experience_level">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <Textarea id="requirements" class="mt-1 block w-full" v-model="form.requirements" rows="4" placeholder="List key requirements, one per line (optional)" />
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <Textarea id="responsibilities" class="mt-1 block w-full" v-model="form.responsibilities" rows="4" placeholder="List key responsibilities, one per line (optional)" />
                            ...
                            <div class="flex items-center justify-end mt-6">
                                <Link :href="route('admin.job-postings.index')" class="text-sm text-gray-600 hover:text-gray-900 underline mr-4">
                                    Cancel
                                </Link>
