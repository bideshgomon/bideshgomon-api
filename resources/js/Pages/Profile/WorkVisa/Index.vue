            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600">Manage your Work Visa applications for working abroad</p>
                    </div>
                    <Link
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-medium text-gray-900">{{ application.job_title || 'Not specified' }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-medium text-gray-900">{{ application.Employer_name || 'Not specified' }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div>
                                                <p class="text-gray-500">Job Start Date</p>
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-medium text-gray-900">
                                                    {{ application.years_of_experience || 'Not taken' }}
                ...
                <div v-else class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">No Work Visa applications yet</h3>
                    <p class="mt-2 text-sm text-gray-500">Get started by creating your first Work Visa application.</p>
                    <div class="mt-6">
                        <Link
                            :href="route('profile.work-visa.create')"
