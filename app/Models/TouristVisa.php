...
class TouristVisa extends Model {
    ...
    public function destinationCountry(): BelongsTo { return $this->belongsTo(Country::class, 'destination_country_id'); }
    public function documents(): HasMany { return $this->hasMany(TouristVisaDocument::class); }
}